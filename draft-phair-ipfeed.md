...
~~~
# ipfeed_version=1.0; publisher=AS64496; publisher_name=Example ISP; generated=2026-02-11T00:00:00Z
~~~
...
|---|---|---|
| `ipfeed_version` | REQUIRED | Format version. MUST be `"1.0"` for this specification. |
...
| `generated` | RECOMMENDED | ISO 8601 timestamp indicating when this file was generated. |
...
Boolean fields use the values `true` and `false` (lowercase). An empty
boolean field means the producer has no data (see {{null-semantics}}).
...
~~~
# ipfeed_version=1.0; publisher=AS64497
...
1. **Prepend a metadata line** with at least `ipfeed_version=1.0`.
...
~~~
# ipfeed_version=1.0; publisher=AS64496
...
~~~
# ipfeed_version=1.0; publisher=AS64496; publisher_name=Example ISP
...
~~~
# ipfeed_version=1.0; publisher=AS64498; publisher_name=Example Cloud; generated=2026-02-11T00:00:00Z; contact_email=noc@cloud.example.com
...
~~~
# ipfeed_version=1.0; publisher=AS64499; publisher_name=Example Cable ISP; contact_email=geofeeds@isp.example.com
...
~~~
# ipfeed_version=1.0; publisher=Example University; generated=2026-01-15T12:00:00Z
...
~~~
# ipfeed_version=1.0; publisher=AS64497; publisher_name=Example Satellite
